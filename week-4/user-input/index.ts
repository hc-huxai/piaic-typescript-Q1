...
let width: number = getInput("Enter the width of the rectangle => ");
let height: number = getInput("Enter the height of the rectangle => ");
...
let sideLength: number = getInput("Enter the length of side of Cube => ");
...
let num: number = getInput("Enter a Number => ");
...
let num1: number = getInput("Enter any Number => ");
...
let personAge: number = getInput("Enter Age => ");
...
let temp: number = getInput("Enter Temperature (Without Unit) =>");
let tempC: number;
let tempF: number;
let tempK: number;
...
// F for Fahrenheit
// K for Kelvin
let tempUnit: string = getInput("Enter Unit of Temperature (C, F, K) =>");
...
let reading: number = getInput("Enter your Reading => ");
let total: number = getInput("Enter your Total => ");
...
let temperature: number = getInput("Enter Temperature => ");
...
let numToDivide: number = getInput("Enter Any Number => ");
...
let unitsConsumed: number = getInput("Enter Consumed Electricity Units => ");
let taxRate: number;
let unitRate = 28;
